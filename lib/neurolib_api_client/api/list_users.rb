...
module NeurolibApiClient
  ...
  #   - +filter+ -> Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression, which allows you to filter users to be listed. Only the users for which the expression is *true* will be returned.
