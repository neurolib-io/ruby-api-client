module NeurolibApiClient
  ...
  ##
  #Set/update (some) property values of a given user. The properties (columns) must be previously created by [Add user property](https://www.neurolib.io/pages/documentation/api.html#add-user-property).
  #
