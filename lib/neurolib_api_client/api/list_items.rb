...
module NeurolibApiClient
  ...
  #   - +filter+ -> Boolean-returning [ReQL](https://www.neurolib.io/pages/documentation) expression, which allows you to filter items to be listed. Only the items for which the expression is *true* will be returned.
