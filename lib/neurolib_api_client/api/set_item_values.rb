module NeurolibApiClient
  ...
  ##
  #Set/update (some) property values of a given item. The properties (columns) must be previously created by [Add item property](https://www.neurolib.io/pages/documentation/api.html#add-item-property).
  #
